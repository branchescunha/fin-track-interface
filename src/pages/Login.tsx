...
const Login = () => {
  ...
  const handleLogin = async () => {
    try {
      ...
      console.error("Erro ao realizar login com o Google", err);
    }
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-200 py-12 px-4 sm:px6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <header>
          <h1 className="text-center text-3xl font-extrabold text-gray-900">FinTrack</h1>
